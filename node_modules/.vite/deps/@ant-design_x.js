...
var PRESET_FILE_ICONS = [{
  key: "default",
  icon: import_react14.default.createElement(FileTextFilled_default, null),
...
function FileListCard(props, ref) {
  ...
  const [finalIcon, iconColor] = import_react14.default.useMemo(() => {
    if (icon) {
  ...
  if (shouldShowImagePreview) {
    ...
    }, finalIcon), import_react14.default.createElement("div", {
...
function FileList(props) {
  ...
  return import_react15.default.createElement("div", {
    ...
    className: (0, import_classnames4.default)(uploadClassName, `${listCls}-upload-btn`),
    style: uploadStyle,
    type: "dashed"
...
function Attachments(props, ref) {
  ...
  if (children) {
    ...
    renderChildren = import_react17.default.createElement("div", {
      ...
      uploadClassName: (0, import_classnames6.default)(contextClassNames.upload, classNames6.upload),
      uploadStyle: {
...
function LoadingButton(props, ref) {
  ...
  return React22.createElement(ActionButton_default, _extends({
    icon: React22.createElement(StopLoading_default, {
...
var ForwardSender = import_react22.default.forwardRef((props, ref) => {
  ...
  return wrapCSSVar(import_react22.default.createElement("div", {
    ...
    className: (0, import_classnames10.default)(`${prefixCls}-content`, contextConfig.classNames.content, classNames6.content),
    style: {
...
var ConversationsItem = (props) => {
  ...
  return import_react26.default.createElement("li", _extends({
  ...
  }, info.label), !disabled && menu && import_react26.default.createElement("div", {
    onClick: stopPropagation
  }, import_react26.default.createElement(dropdown_default, {
    menu: dropdownMenu,
...
var Conversations = (props) => {
  ...
  return wrapCSSVar(import_react28.default.createElement("ul", _extends({}, domProps, {
    ...
    const convItems = groupInfo.data.map((convInfo, convIndex) => {
      ...
      return import_react28.default.createElement(Item_default, _extends({}, restInfo, {
        key: convInfo.key || `key-${convIndex}`,
        info: convInfo,
        prefixCls,
        direction,
        className: (0, import_classnames15.default)(classNames6.item, contextConfig.classNames.item, convInfo.className),
        style: {
...
var ThoughtChainNode = (props) => {
  ...
  const [showTooltip, setShowTooltip] = import_react31.default.useState(false);
  const textRef = import_react31.default.useRef(null);
  ...
  }, import_react31.default.createElement(tooltip_default, {
